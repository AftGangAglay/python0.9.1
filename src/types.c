...
const struct py_type_info py_types[PY_TYPE_MAX] = {
		/* Type */
		{ sizeof(struct py_type_info), 0, 0, 0, 0, 0, 0, 0 },
		/* None */
		{ 0 },

		/* Class */
		{ sizeof(struct py_class), py_class_dealloc, 0, 0, 0, 0, 0, 0 },
		/* Class Member */
		{
				sizeof(struct py_class_member),
				py_class_member_dealloc, 0, 0, 0, 0,
				py_class_member_serialize, 0
		},
		/* Class Method */
		{
				sizeof(struct py_class_method),
				py_class_method_dealloc, 0, 0, 0, 0, 0, 0
		},

		/* Code */
		{
				sizeof(struct py_code),
				py_code_dealloc, 0, 0, 0, 0,
				0, 0
		},
		/* Frame */
		{ sizeof(struct py_frame), py_frame_dealloc, 0, 0, 0, 0, 0, 0 },
		/* Traceback */
		{ sizeof(struct py_traceback), py_traceback_dealloc, 0, 0, 0, 0, 0, 0 },
		/* Func */
		{ sizeof(struct py_func), py_func_dealloc, 0, 0, 0, 0, 0, 0 },
		/* Method */
		{ sizeof(struct py_method), py_method_dealloc, 0, 0, 0, 0, 0, 0 },
		/* Module */
		{ sizeof(struct py_module), py_module_dealloc, 0, 0, 0, 0, 0, 0 },
